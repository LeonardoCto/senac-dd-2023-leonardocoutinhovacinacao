...
public class Executavel {
	public static void main(String[] args) {
		...
		// CADASTRO DE PESSOA
		  ...
		  Pessoa pessoa1 = new Pessoa(null, "Leonardo Coutinho", TipoPessoa.VOLUNTARIOS, "54865901845", LocalDateTime.of(2002, 10, 24, 0, 0), 'M');
		  Pessoa pessoa2 = new Pessoa(null, "Joao Gomes", TipoPessoa.PUBLICO_GERAL, "10044587954", LocalDateTime.of(2002, 11, 5, 0, 0), 'M');
		  PessoaDAO dbaDePessoas = new PessoaDAO();
		 
		  dbaDePessoas.inserir(pessoa1); dbaDePessoas.inserir(pessoa2);
		...
		Vacina vacina1 = new Vacina(null, "COVID", "Brasil", EstagioPesquisa.APLICACAO_EM_MASSA, LocalDateTime.now(), dbaDePessoas.consultarPorId(2));
		Vacina vacina2 = new Vacina(null, "H1N1", "Estados Unidos", EstagioPesquisa.INICIAL, LocalDateTime.now(),
				dbaDePessoas.consultarPorId(1));
		Vacina vacina3 = new Vacina(null, "DENGUE", "Brasil", EstagioPesquisa.TESTES, LocalDateTime.now(),
				dbaDePessoas.consultarPorId(3));
